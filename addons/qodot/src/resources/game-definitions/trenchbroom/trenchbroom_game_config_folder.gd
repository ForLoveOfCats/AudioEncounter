...
export(Resource) var game_config_file : Resource = preload("res://MapAssets/game_definitions/trenchbroom/qodot_trenchbroom_config_file.tres")
export(Array, Resource) var fgd_files : Array = [
	preload("res://MapAssets/game_definitions/fgd/qodot_fgd.tres")
]
